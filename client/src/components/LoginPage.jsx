      ...
      <div className="relative z-10 w-full max-w-sm md:max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl">
          ...
          <div className="bg-linear-to-r from-blue-600 to-blue-800 px-4 sm:px-6 py-6 sm:py-8 text-center">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">Trellysis</h1>
            <p className="text-blue-100 text-xs sm:text-sm">Student Management Portal</p>
          </div>
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
              ...
              {/* Demo Info */}
              <div className="bg-blue-50 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-1 sm:space-y-2 text-xs sm:text-sm">
                <p className="text-gray-700">
                  <span className="font-semibold">Student:</span> <span className="text-blue-600">student@example.com</span>
                </p>
                <p className="text-gray-700">
                  <span className="font-semibold">Faculty:</span> <span className="text-blue-600">faculty@example.com</span>
                </p>
                <p className="text-gray-700">
                  <span className="font-semibold">Password:</span> <span className="text-blue-600">password123</span>
                </p>
              </div>
