      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl">
          <div className="bg-linear-to-r from-blue-600 to-blue-800 px-6 py-8 text-center">
            ...
            <p className="text-blue-100 text-sm">Join Trellysis Portal</p>
          </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              {success && (
                <div className="p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm font-medium flex items-start gap-3">
